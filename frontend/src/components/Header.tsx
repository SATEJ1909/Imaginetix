...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center py-20'>
      ...
      <p className='text-center max-w-xl mx-auto mt-5'>Unleash your creativity with AI , Turn your imagination into visual art in seconds - jus type , and watch the magic happen</p>
      ...
      <p className='mt-2 text-neutral-600'>Geneated Images from Imagify</p>
    </div>
  )
}
