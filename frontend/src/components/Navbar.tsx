...
function Navbar() {
  ...
  const {user , setShowLogin , credit , logOut , setCredit} = useContext(AppContext);
        ...
        {user ? 
         <div className='flex items-center gap-2 sm:gap-3'>
           <button className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
            ...
            <p className='text-xs sm:text-sm font-medium text-gray-600'>Credit left : {setCredit ? credit : 0}</p>
           </button>
